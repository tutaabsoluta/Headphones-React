...
export const Products = () => {
  return (
    <main className="container mx-auto text-blue-500">
      <h2 className="tracking-tighter bg-gradient-to-r from-green-500 to-blue-500 bg-clip-text text-transparent text-center mt-8">
        Elige los TechPRO
      </h2>

      {/* Grid para modelos */}
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:grid-rows-2 md:grid-flow-col">
        ...
        <div className="modelo modelo-z md:row-span-2">
